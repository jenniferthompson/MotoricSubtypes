...
putHfig(plot(summaryM(days.hyperdel.imp + days.hyperdel.exp + days.bothdel.imp +
                        days.bothdel.exp ~ ptgroup,
                      data = all.oneobs.desc, continuous = 5), which = 'continuous'))
putHfig(plot(summaryM(days.onlyhypo.imp + days.onlyhypo.exp + days.onlyhyper.imp +
                        days.onlyhyper.exp ~ ptgroup,
                      data = all.oneobs.desc, continuous = 5), which = 'continuous'))
