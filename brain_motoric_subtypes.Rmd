...
```{r combinedata}
## -- Source scripts: ------------------------------------------------------------------------------
## -- 1. Either combines BRAIN+MINDICU data, or sets up BRAIN data, depending on operating system; -
## --    creates "all.xxxxx" data sets to use in rest of analysis ----------------------------------
## -- 2. Function to create data sets for time-varying Cox models ----------------------------------
